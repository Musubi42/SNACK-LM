...
<div class="swiper-container">
    ...
    <?php // Gère les fonctions de défilement 
    ?>
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <img src="modules/swiper-images/Kebab-frites.png" alt="Kebab-frites" />
        </div>
        <div class="swiper-slide">
            <img src="modules/swiper-images/Burger.png" alt="Burger" />
        </div>
        <div class="swiper-slide">
            <img src="modules/swiper-images/Assiette.png" alt="Assiette" />
        </div>
    </div>

    <?php // Les boutons en bas 
    ?>
    <div class="swiper-pagination swiper-pagination-black"></div>

    <?php // Les boutons suivant/précédent 
    ?>
